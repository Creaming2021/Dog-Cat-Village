...
type MainCategoryProps = {
    onChangeCategory: (category: 
                        'home' | 'notice' | 'board' | 'animal' | 'chatting' | 'donation') 
                        => void,
}
    ...
    <div className={styles['main-category']}>
        ...
        <div className={styles.bottom}>
            <button 
                ...
                onClick={onClick} value="home">홈</button>
            <button 
                className={`${commons['bg-green']} ${commons['btn-middle']}`}
                onClick={onClick} value="notice">공지사항</button>
            <button 
                className={`${commons['bg-green']} ${commons['btn-middle']}`}
                onClick={onClick} value="board">게시판</button>
            <button 
                className={`${commons['bg-green']} ${commons['btn-middle']}`}
                onClick={onClick} value="animal">보호 동물</button>
            <button 
                className={`${commons['bg-green']} ${commons['btn-middle']}`}
                onClick={onClick} value="chatting">1:1 채팅</button>
            <button 
                className={`${commons['bg-green']} ${commons['btn-middle']}`}
                onClick={onClick} value="donation">후원하기</button>
            <div
                className={`${styles['introduction-box']}`}>
                <FontAwesomeIcon 
